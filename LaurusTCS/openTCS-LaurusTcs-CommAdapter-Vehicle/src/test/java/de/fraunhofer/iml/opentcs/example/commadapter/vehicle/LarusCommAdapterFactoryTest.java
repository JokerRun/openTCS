 ...
 */
public class LarusCommAdapterFactoryTest {

  private LarusCommAdapterFactory commAdapterFactory;

  @Before
  public void setUp() {
    commAdapterFactory = new LarusCommAdapterFactory(mock(LarusAdapterComponentsFactory.class));
  }
