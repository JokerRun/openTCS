...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.exchange.LarusCommAdapterDescription;
...
public class LarusCommAdapterFactory
    implements VehicleCommAdapterFactory {

  /**
   * This class's Logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(LarusCommAdapterFactory.class);
   ...
   */
  @Inject
  public LarusCommAdapterFactory(LarusAdapterComponentsFactory componentsFactory) {
  ...
  public VehicleCommAdapterDescription getDescription() {
    return new LarusCommAdapterDescription();
  }
  ...
  public VehicleCommAdapter getAdapterFor(Vehicle vehicle) {
    ...
    LarusCommAdapter adapter = componentsFactory.createLarusCommAdapter(vehicle);
