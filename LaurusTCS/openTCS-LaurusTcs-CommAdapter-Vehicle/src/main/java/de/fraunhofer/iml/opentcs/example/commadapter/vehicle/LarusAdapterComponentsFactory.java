 ...
 */
public interface LarusAdapterComponentsFactory {

  /**
   * Creates a new LarusCommAdapter for the given vehicle.
   *
   * @param vehicle The vehicle
   * @return A new LarusCommAdapter for the given vehicle
   */
  LarusCommAdapter createLarusCommAdapter(Vehicle vehicle);
