...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.LarusProcessModel;
...
/**
 * A serializable representation of a {@link LarusProcessModel}.
 ...
 */
public class LarusProcessModelTO
   ...
   * @return This
   */
  public LarusProcessModelTO setVehicleRef(TCSObjectReference<Vehicle> vehicleRef) {
   ...
   * @return This
   */
  public LarusProcessModelTO setCurrentState(
   ...
   * @return This
   */
  public LarusProcessModelTO setPreviousState(
   ...
   * @return This
   */
  public LarusProcessModelTO setLastOrderSent(
   ...
   * @return This
   */
  public LarusProcessModelTO setVehicleHost(String vehicleHost) {
   ...
   * @return This
   */
  public LarusProcessModelTO setVehiclePort(int vehiclePort) {
   ...
   * @return This
   */
  public LarusProcessModelTO setPeriodicStateRequestEnabled(boolean periodicStateRequestEnabled) {
   ...
   * @return This
   */
  public LarusProcessModelTO setStateRequestInterval(int stateRequestInterval) {
   ...
   * @return This
   */
  public LarusProcessModelTO setVehicleIdleTimeout(int vehicleIdleTimeout) {
   ...
   * @return This
   */
  public LarusProcessModelTO setVehicleIdle(boolean vehicleIdle) {
   ...
   * @return This
   */
  public LarusProcessModelTO setDisconnectingOnVehicleIdle(boolean disconnectingOnVehicleIdle) {
   ...
   * @return This
   */
  public LarusProcessModelTO setReconnectingOnConnectionLoss(boolean reconnectingOnConnectionLoss) {
   ...
   * @return This
   */
  public LarusProcessModelTO setReconnectDelay(int reconnectDelay) {
   ...
   * @return This
   */
  public LarusProcessModelTO setLoggingEnabled(boolean loggingEnabled) {
