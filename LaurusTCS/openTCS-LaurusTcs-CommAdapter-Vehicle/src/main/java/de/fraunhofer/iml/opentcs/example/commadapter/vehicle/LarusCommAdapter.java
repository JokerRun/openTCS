...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.exchange.LarusProcessModelTO;
...
public class LarusCommAdapter
   ...
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(LarusCommAdapter.class);
  /**
   ...
   */
  private final LarusAdapterComponentsFactory componentsFactory;
  /**
   ...
   */
  @Inject
  public LarusCommAdapter(@Assisted Vehicle vehicle,
                            OrderMapper orderMapper,
                            LarusAdapterComponentsFactory componentsFactory) {
    super(new LarusProcessModel(vehicle), 3, 2, LoadAction.CHARGE);
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    if (!(evt.getSource() instanceof LarusProcessModel)) {
      return;
    }
    ...
    if (Objects.equals(evt.getPropertyName(),
        ...
        || Objects.equals(evt.getPropertyName(),
                          LarusProcessModel.Attribute.PERIODIC_STATE_REQUESTS_ENABLED.name())) {
      if (getProcessModel().isCommAdapterConnected()
    ...
    if (Objects.equals(evt.getPropertyName(),
                       LarusProcessModel.Attribute.PERIOD_STATE_REQUESTS_INTERVAL.name())) {
  ...
  @Override
  public final LarusProcessModel getProcessModel() {
    return (LarusProcessModel) super.getProcessModel();
  }
  ...
  protected VehicleProcessModelTO createCustomTransferableProcessModel() {
    ...
    //plant overview
    return new LarusProcessModelTO()
