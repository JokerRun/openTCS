...
/**
 * A custom model for the {@link LarusCommAdapter} which holds additional information
 * about the connected vehicle.
 *
 * @author Mats Wilhelm (Fraunhofer IML)
 */
public class LarusProcessModel
   ...
   */
  public LarusProcessModel(Vehicle attachedVehicle) {
